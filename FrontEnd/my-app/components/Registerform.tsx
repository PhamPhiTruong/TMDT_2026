...
export default function RegisterForm() {
  ...
  const validate = (): FormErrors => {
    ...
    if (!form.soDienThoai.trim()) {
      ...
      !/^(0|\+84)[0-9]{9}$/.test(form.soDienThoai.replace(/\s/g, ''))
    ) {
  ...
  const handleSocialLogin = (provider: string) => {
    alert(`Đăng ký với ${provider} (chức năng demo)`);
  };
  ...
  const passwordStrength = (() => {
    ...
    if (score <= 2)
      return { label: 'Trung bình', color: 'bg-accent', width: 'w-2/4' };
    if (score <= 3)
      return { label: 'Khá', color: 'bg-yellow-400', width: 'w-3/4' };
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                value={form.ho}
                onChange={setField('ho')}
                placeholder="Họ"
                className={inputClass(errors.ho)}
              />
              {errors.ho && (
                <p className="mt-1 text-xs text-danger flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" /> {errors.ho}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Tên"
                className={inputClass(errors.ten)}
              />
              {errors.ten && (
                <p className="mt-1 text-xs text-danger flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" /> {errors.ten}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={setField('soDienThoai')}
                placeholder="Số điện thoại"
                className={inputClass(errors.soDienThoai)}
              />
              {errors.soDienThoai && (
                <p className="mt-1 text-xs text-danger flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" /> {errors.soDienThoai}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.matKhau && (
                <p className="mt-1 text-xs text-danger flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" /> {errors.matKhau}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`${inputClass(errors.xacNhanMatKhau)} pr-11`}
                />
                <button
                  type="button"
              ...
              {errors.xacNhanMatKhau && (
                <p className="mt-1 text-xs text-danger flex items-center gap-1">
                  <AlertCircle className="w-3 h-3" /> {errors.xacNhanMatKhau}
                </p>
              )}
            </div>
          </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2.5 border border-gray-200 rounded-lg py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2.5 border border-gray-200 rounded-lg py-2.5 text-sm font-medium text-gray-700 hover:bg-blue-50 hover:border-blue-200 transition-all"
          >
