...
import { adminChangePassword } from '@/lib/adminAuthService';
  ...
  return (
    <div>
      <div className="mb-6 border-b border-gray-200 pb-4">
        ...
        <p className="text-sm text-gray-500 mt-1">Quản lý an toàn tài khoản quản trị viên</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:items-center pt-4">
            ...
            <div className="md:col-span-2">
              ...
              >
                {isLoading ? <><Loader2 className="w-4 h-4 animate-spin" /> Đang xử lý...</> : 'Xác Nhận Đổi'}
              </button>
            </div>
          </div>
        </form>
